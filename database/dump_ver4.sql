...
-- Dumping data for table conveient_store.hanghoa: ~2 rows (approximately)
INSERT INTO `hanghoa` (`MSHH`, `TenHH`, `MoTa`, `HinhMoTa`, `Gia`, `SoLuongHang`, `MaLoaiHang`) VALUES
	(1, '6 lon nước ngọt Pepsi Cola 320ml', 'abcd', 'pepsi.png', '54000', 12, 1),
	(2, '6 chai Sting hương dâu 330ml', 'abcd', 'sting.png', '49000', 34, 1),
	(3, 'Thùng 12 lon bia Tiger 500ml', 'abcd', 'tiger.png', '210000', 45, 1),
	...
	(23, 'Bánh xốp phủ socola KitKat gói 204g', 'abcd', 'kitkat.png', '53500', 27, 3),
	(24, 'Hạt hướng dương vị dừa Chacheer gói 130g', 'abcd', 'chaccheer.png', '20000', 70, 3),
	(25, 'Bánh quy caramel flan AFC hộp 125g', 'abcd', 'afc.png', '19500', 46, 3),
	(26, 'Kẹo Ferrero Confetteria Raffaello hộp 150g', 'abcd', 'ferrero.png', '171000', 76, 3),
	(27, 'Bánh quy bơ Danisa hộp 454g', 'abcd', 'danisa.png', '132000', 46, 3),
	(28, 'Mít sấy Vinamit gói 250g', 'abcd', 'vinamit.png', '92500', 57, 3),
	(29, 'Bánh trứng tươi chà bông Karo gói 156g', 'abcd', 'karo.png', '39000', 36, 3);
...
-- Dumping data for table conveient_store.loaihanghoa: ~2 rows (approximately)
