...
--
-- Host: localhost
-- Generation Time: Apr 20, 2023 at 07:47 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `admin_add_image` (IN `ten_hinh_anh` VARCHAR(50), IN `maHH` VARCHAR(50))   BEGIN
INSERT INTO hinhhanghoa(TenHinh, MSHH) VALUES (ten_hinh_anh, maHH);
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `admin_add_products` (IN `tenHH` VARCHAR(100), IN `moTa` VARCHAR(10000), IN `price` VARCHAR(200), IN `soluong` INT(10), IN `hinhMota` VARCHAR(200), IN `maLoaiHang` INT(11))   BEGIN
...
(33, 'Ipad M1', 'Hello W', '1682011710-img1-Ảnh màn hình 2023-04-10 lúc 15.37.20.png', '3000000000', 300, 100),
(34, 'Product 1', 'Hello World', '1682012166-img1-Ảnh màn hình 2023-04-10 lúc 15.37.20.png', '4000000', 20, 101),
(35, '1', 'sdf,jsadf,', '1682012442-img1-Ảnh màn hình 2023-04-09 lúc 12.24.30.png', '3000', 30, 101),
(37, 'dfasjdhfl', 'asdfjasldfj', 'asdfasdfdf', '300000', 20, 99);
...
(63, '1682011710-img1-Ảnh màn hình 2023-04-10 lúc 15.37.20.png', 33),
(64, '1682011710-img2-Ảnh màn hình 2023-04-13 lúc 01.51.54.png', 33),
(65, '1682011710-img3-Ảnh màn hình 2023-04-09 lúc 12.24.30.png', 33),
(67, '1682012442-img1-Ảnh màn hình 2023-04-09 lúc 12.24.30.png', 35);
...
--
ALTER TABLE `hanghoa`
  MODIFY `MSHH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `hinhhanghoa`
--
ALTER TABLE `hinhhanghoa`
  MODIFY `MaHinh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
